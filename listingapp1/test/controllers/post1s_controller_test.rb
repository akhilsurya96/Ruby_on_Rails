...
class Post1sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post1" do
    assert_difference('Post1.count') do
      post post1s_url, params: { post1: { description: @post1.description, genere: @post1.genere, integer: @post1.integer, no.of: @post1.no.of, pages: @post1.pages, string: @post1.string, title: @post1.title } }
    end
  ...
  test "should update post1" do
    patch post1_url(@post1), params: { post1: { description: @post1.description, genere: @post1.genere, integer: @post1.integer, no.of: @post1.no.of, pages: @post1.pages, string: @post1.string, title: @post1.title } }
