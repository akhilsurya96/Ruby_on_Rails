...
class Post2sControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create post2" do
    assert_difference('Post2.count') do
      post post2s_url, params: { post2: { description: @post2.description, genere: @post2.genere, npages: @post2.npages, sno: @post2.sno, title: @post2.title } }
    end
  ...
  test "should update post2" do
    patch post2_url(@post2), params: { post2: { description: @post2.description, genere: @post2.genere, npages: @post2.npages, sno: @post2.sno, title: @post2.title } }
